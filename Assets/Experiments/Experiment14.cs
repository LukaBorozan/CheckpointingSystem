...
public class Experiment14 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        MemberInfo info = type.GetProperty("intProperty");

        var reflectionReadWatch = System.Diagnostics.Stopwatch.StartNew();
        for (int i = 0; i < COUNT; ++i)
        {
            type.GetProperty("intProperty").GetValue(instance);
        }
        ...
        for (int i = 0; i < COUNT; ++i)
        {
            type.GetProperty("intProperty").SetValue(instance, 2);
        }
